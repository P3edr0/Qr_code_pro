...
void main() {
  group('Testes de widget da página InsertImagePage', () {
    initInjection();
    ...
    testWidgets('Teste  InsertImagePage Resume', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: InsertImagePage(),
        ),
      );

      expect(find.text('INSERIR IMAGEM'), findsWidgets);
      ...
      expect(find.text("Códigos capturados"), findsOneWidget);
    });

    testWidgets('Teste Shared Button', (WidgetTester tester) async {
      Color sharedColor = ProjectColors.darkGreen;
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: SharedQrCodeButton(
              ...
              changeSharedButtonColor: () {
                sharedColor = ProjectColors.lightGreen;
              },
            ),
          ),
        ),
      ...
      expect(sharedColor, ProjectColors.lightGreen);
    });
